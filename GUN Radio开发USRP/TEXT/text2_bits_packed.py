...
class text2_bits_packed(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "bits packed", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("bits packed")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "text2_bits_packed")
        ...
        self.qtgui_histogram_sink_x_1_0.enable_accumulate(False)
        ...
        self._qtgui_histogram_sink_x_1_0_win = sip.wrapinstance(self.qtgui_histogram_sink_x_1_0.qwidget(), Qt.QWidget)
        self.top_layout.addWidget(self._qtgui_histogram_sink_x_1_0_win)
        ...
        self.connect((self.blocks_char_to_float_0_0, 0), (self.qtgui_histogram_sink_x_0, 0))
        self.connect((self.blocks_char_to_float_0_1, 0), (self.qtgui_histogram_sink_x_1, 0))
        self.connect((self.blocks_char_to_float_0_1_0, 0), (self.qtgui_histogram_sink_x_1_0, 0))
        ...
        self.connect((self.blocks_throttle2_0, 0), (self.blocks_char_to_float_0_1_0, 0))
...
def main(top_block_cls=text2_bits_packed, options=None):

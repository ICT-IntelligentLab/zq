...
class text8_GFSK_mod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "GFSK mod", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("GFSK mod")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "text8_GFSK_mod")
        ...
        self.connect((self.blocks_pack_k_bits_bb_0, 0), (self.blocks_uchar_to_float_1, 0))
        self.connect((self.blocks_repack_bits_bb_0, 0), (self.blocks_uchar_to_float_0, 0))
        self.connect((self.blocks_stream_to_tagged_stream_0, 0), (self.blocks_uchar_to_float_2, 0))
        ...
        self.connect((self.blocks_uchar_to_float_2, 0), (self.blocks_delay_0, 0))
...
def main(top_block_cls=text8_GFSK_mod, options=None):

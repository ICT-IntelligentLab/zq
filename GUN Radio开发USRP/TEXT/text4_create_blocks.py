...
from frequency_shifter_block import frequency_shifter_block  # grc-generated hier_block
...
class text4_create_blocks(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "create blocks", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("create blocks")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "text4_create_blocks")
        ...
        self._frequency_range = qtgui.Range(-10000, 10000, 1000, 0, 200)
        ...
        self.low_pass_filter_0 = filter.fir_filter_ccf(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.frequency_shifter_block_0 = frequency_shifter_block(
            frequency=frequency,
            samp_rate=samp_rate,
        )
        ...
        self.connect((self.frequency_shifter_block_0, 0), (self.blocks_throttle2_0, 0))
        self.connect((self.low_pass_filter_0, 0), (self.frequency_shifter_block_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.frequency_shifter_block_0.set_samp_rate(self.samp_rate)
    ...
    def set_frequency(self, frequency):
        ...
        self.frequency_shifter_block_0.set_frequency(self.frequency)




def main(top_block_cls=text4_create_blocks, options=None):

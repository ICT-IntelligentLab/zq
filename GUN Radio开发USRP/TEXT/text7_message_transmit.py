...
import sip
import text7_message_transmit_epy_block_0 as epy_block_0  # embedded python block
import text7_message_transmit_epy_block_1 as epy_block_1  # embedded python block
import threading



class text7_message_transmit(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "message transmit", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("message transmit")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "text7_message_transmit")
...
def main(top_block_cls=text7_message_transmit, options=None):

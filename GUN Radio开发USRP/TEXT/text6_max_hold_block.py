...
import sip
import text6_max_hold_block_epy_block_0 as epy_block_0  # embedded python block
import threading



class text6_max_hold_block(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "max hold block", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("max hold block")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "text6_max_hold_block")
        ...
        self.pdu_tagged_stream_to_pdu_0 = pdu.tagged_stream_to_pdu(gr.types.float_t, '64')
        self.epy_block_0 = epy_block_0.blk(vectorSize=16)
        self.blocks_vector_to_stream_1 = blocks.vector_to_stream(gr.sizeof_float*1, 16)
        self.blocks_vector_to_stream_0 = blocks.vector_to_stream(gr.sizeof_float*1, 16)
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_float*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_stream_to_vector_1 = blocks.stream_to_vector(gr.sizeof_float*1, 16)
...
def main(top_block_cls=text6_max_hold_block, options=None):

...
class text1_variable(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "variable", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "text1_variable")
        ...
        self._frequency_options = [1000, -1000, 0]
        # Create the labels list
        self._frequency_labels = ['1', '2', '3']
...
def main(top_block_cls=text1_variable, options=None):

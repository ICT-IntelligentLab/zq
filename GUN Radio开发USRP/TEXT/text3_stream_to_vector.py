...
class text3_stream_to_vector(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "stream to vector", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("stream to vector")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "text3_stream_to_vector")
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 100, 0.5, 0, 0)
        ...
        self.connect((self.blocks_vector_to_streams_0, 0), (self.qtgui_time_sink_x_1, 0))
        self.connect((self.blocks_vector_to_streams_0, 1), (self.qtgui_time_sink_x_2, 0))
...
def main(top_block_cls=text3_stream_to_vector, options=None):
